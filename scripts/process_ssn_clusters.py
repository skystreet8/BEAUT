...
if args.model in {'base', 'aug'}:
    ...
    clu_60 = pickle.load(open(f'../data/PRJNA28331_{args.model}/PRJNA28331_{args.model}_alnscore60_full_clusters.pkl', 'rb'))
    ...
    cluster_info.to_csv(f'../data/PRJNA28331_{args.model}/PRJNA28331_{args.model}_alnscore60_ssn_clusters_full/cluster_info.csv',
                        index=False)
    ...
    qdf.to_csv(f'../data/PRJNA28331_{args.model}/PRJNA28331_{args.model}_alnscore60_ssn_clusters_full/cluster_results.csv',
               index=False)
else:
