...
if args.model == 'base':
    ...
    remove_indexes = [i for i in df_with_desc.index if i not in keep_ase_indexes and i not in discard_ase_indexes]
    ...
    for t in not_ase_df.itertuples():
        desc = t[8].lower()
        # Recover uncharactorised sequences
    ...
    full_df.to_csv(
        '../data/PRJNA28331_base/PRJNA28331_filtered_proteins_positive_results_base_filtered_by_annotation.csv',
        index=False)
