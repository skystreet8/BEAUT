...
org_count_df.to_csv('../data/PRJNA28331_aug/PRJNA28331_aug_num_positive_seqs_by_organism.csv',
                    index=False)
...
org_ec_count_df.to_csv('../data/PRJNA28331_aug/PRJNA28331_aug_seq_ec_counts_by_organism.csv',
                       index=False)
